...
class PolymorphismDemo{
	public static void main(String[] args){
		...
		// HDFC h_p = new HDFC_PUNE();
		// HDFC h_b = new HDFC_BHOPAL();
		// h_p.display();
		// h_p.displayInterestRate();
		// h_b.display();
		// h_b.displayInterestRate();
		...
		Bank h_p = new HDFC_PUNE();
		Bank h_b = new HDFC_BHOPAL();
		// h_p.display();
		// h_p.displayInterestRate();
		// h_b.display();
		// h_b.displayInterestRate();
		// h.display();
		// h.displayInterestRate();


		Bank[] bank_array = new Bank[10];
		bank_array[0] = new HDFC_PUNE();
		bank_array[1] = new HDFC_BHOPAL();

		bank_array[0].display();
		bank_array[1].display();
	};
};
